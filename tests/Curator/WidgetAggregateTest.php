...
final class WidgetAggregateTest extends AbstractPbjxTest
{
    public function testCreateAggregate(): void
    {
        ...
        $this->assertTrue(NodeStatus::PUBLISHED->value === $aggregate->getNode()->get('status'));
    }
    ...
    public function testCreateNode(): void
    {
        ...
        $this->assertTrue(NodeStatus::PUBLISHED->value === $events[0]->get('node')->get('status'));
    }
    ...
    public function testUpdateNode(): void
    {
        ...
        $events = $aggregate->getUncommittedEvents();
        $this->assertTrue(NodeStatus::PUBLISHED->value === $events[0]->get('new_node')->get('status'));
    }
}
