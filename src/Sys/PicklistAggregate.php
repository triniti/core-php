...
class PicklistAggregate extends Aggregate
{
    ...
    {
        $newName = str_replace('Picklist', 'Node', $name);
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-expired:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-locked:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-marked-as-draft:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-marked-as-pending:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-published:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-renamed:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-scheduled:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-unlocked:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-unpublished:v1')::create();
    }
    ...
    {
        return MessageResolver::resolveCurie('*:sys:event:picklist-updated:v1')::create();
    }
}
